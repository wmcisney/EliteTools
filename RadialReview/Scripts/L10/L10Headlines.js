...
var clickHeadlineRow = function (evt) {
	...
	$(detailsContents).append("<div class='createTime'>" + clientDateFormat(new Date(createtime)) + "</div>");
	...
	$(detailsContents).append("<iframe class='details headline-details on-edit-enabled' name='embed_readwrite' src='https://note.dlptools.com/p/" + padId + "?showControls=true&showChat=false&showLineNumbers=false&useMonospaceFont=false&userName=" + encodeURI(UserName) + "' width='100%' height='100%'></iframe>");
	...
	$(detailsContents).append(
		...
		(aboutName ? "<div class='gray' style='display:inline-block;padding-top: 6px;'>About:</div><div style='' class='about' data-about='" + about + "' data-headline='" + headline + "'  >" + aboutName + "</div>" : "") +
		//"<div >" +
