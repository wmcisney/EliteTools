...
namespace RadialReview.Models {
	...
	public class UserOrganizationModel : ResponsibilityGroupModel, IOrigin, IHistorical, TimeSettings, IForModel/*, IAngularizer<UserOrganizationModel>*/
	{
		...
		public class AdminShortCircuit {
			...
			public bool isCompassAdmin { get; set; }
		...
		public virtual bool _IsCompassAdmin { get; set; }
		...
		public virtual Boolean IsCompassAdmin { get; set; }
...
#pragma warning restore CS0114 // Member hides inherited member; missing override keyword
		...
		public virtual bool GetCompassAdmin() {
			var user = this.NotNull(x => x.User);
			if (user != null)
			{
				return User.IsCompassAdmin;
			}
			else {
				return false;
			}
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		public class PrimaryCompassModel {
			public CompassType Type { get; set; }
			public long CompassId { get; set; }
			public class Map : ComponentMap<PrimaryCompassModel>
			{
				public Map()
				{
					this.Map(x => x.Type).CustomType<CompassType>();
					this.Map(x => x.CompassId);
				}
			}
		}

		public virtual PrimaryWorkspaceModel PrimaryWorkspace { get; set; }
		public virtual PrimaryCompassModel PrimaryCompass { get; set; }
